...
<Card title="Twenty CRM" href="/integrations/twenty/overview">
  Trigger Samvaad outbound calls from Twenty workflows and sync call outcomes back to CRM records
</Card>
